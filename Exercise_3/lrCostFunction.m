...
% step 1 didtribute the summation operation to find the cost
h = sigmoid( X * theta ); 
product_1 = y .* log( h );
...
% we can set theta(1) to zero. Since we already calculated h using theta 
% and theta is a local variable, we can modify theta(1) without causing any problems.
